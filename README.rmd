...
output:
  pagedown::html_paged:
    ...
    self_contained: TRUE
abstract: |
    This is my ReadMe, as an html to show my steps and functions

---

# Purpose

The following code is used to illustrate the effect of fees on investor's cumulative returns
...
To apply annual fees, I am going to convert the daily data, to weekly data using the xts package, and a function
...
weekly_df_2002 <- cumulative_return_with_fees(df = weekly_df_2002, bps = 50, time_frame = 52)
weekly_df_2002 <- cumulative_return_with_fees(df = weekly_df_2002, bps = 100, time_frame = 52)
weekly_df_2002 <- cumulative_return_with_fees(df = weekly_df_2002, bps = 200, time_frame = 52)
weekly_df_2002 <- cumulative_return_with_fees(df = weekly_df_2002, bps = 250, time_frame = 52)
weekly_df_2002 <- cumulative_return_with_fees(df = weekly_df_2002, bps = 350, time_frame = 52)
...
I want to get the last values and then work out the difference in cumulative returns 
